...
export const dictionaries = {
  "zh-CN": {
    ...
    "drawer.colorDark": "深色",
    "drawer.userAgent": "User-Agent",
    "drawer.userAgentCustom": "自定义 User-Agent",
    "drawer.userAgentHint": "填写完整的 UA 字符串",
    "drawer.uaDefault": "Browser Run 默认",
    "drawer.uaCustom": "自定义…",
    "drawer.uaDefaultPreview": "使用 Browser Run 自带的 UA",
    ...
    "fingerprint.title": "指纹不一致",
    "fingerprint.fix": "一键对齐",
    "fingerprint.aligned": "已对齐区域、语言、时区与 UA。",
    "fingerprint.region-locale": "语言与出口区域不符，建议 {value}。",
    "fingerprint.region-timezone": "时区与出口区域不符，建议 {value}。",
    "fingerprint.device-ua": "UA 平台与设备类型不符，建议 {value}。",
  ...
  en: {
    ...
    "drawer.userAgent": "User-Agent",
    "drawer.userAgentCustom": "Custom User-Agent",
    "drawer.userAgentHint": "Paste a full UA string",
    "drawer.uaDefault": "Browser Run default",
    "drawer.uaCustom": "Custom…",
    "drawer.uaDefaultPreview": "Using the built-in Browser Run UA",
    ...
    "fingerprint.title": "Inconsistent fingerprint",
    "fingerprint.fix": "Auto align",
    "fingerprint.aligned": "Region, language, time zone and UA now agree.",
    "fingerprint.region-locale": "Language does not match the exit region — {value} fits.",
    "fingerprint.region-timezone": "Time zone does not match the exit region — {value} fits.",
    "fingerprint.device-ua": "UA platform does not match the device — {value} fits.",
